...
Source0  : https://files.pythonhosted.org/packages/61/ca/501363184557b9778756a9a63ab4e7cb4f8dcf8df15a2e53bc3ae21d292a/notebook-6.4.8.tar.gz
...
%prep
%setup -q -n notebook-6.4.8
cd %{_builddir}/notebook-6.4.8
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1643214230
...
cp %{_builddir}/notebook-6.4.8/LICENSE %{buildroot}/usr/share/package-licenses/pypi-notebook/16d10493731a4bebeb353de88f3427006e13da11
