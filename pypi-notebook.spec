...
Source0  : https://files.pythonhosted.org/packages/52/1e/b555b6e33c962a605e2e85b6014f609d3e1c6a5ff48f7c2480376b430d96/notebook-6.5.4.tar.gz
...
%prep
%setup -q -n notebook-6.5.4
cd %{_builddir}/notebook-6.5.4
pushd ..
cp -a notebook-6.5.4 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1680824209
