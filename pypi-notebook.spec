...
Source0  : https://files.pythonhosted.org/packages/01/cc/0e768bc9b46b23d109409ba13c8ae530295bb465c843cdb59c7466d919df/notebook-6.4.10.tar.gz
...
%prep
%setup -q -n notebook-6.4.10
cd %{_builddir}/notebook-6.4.10
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647447861
...
cp %{_builddir}/notebook-6.4.10/LICENSE %{buildroot}/usr/share/package-licenses/pypi-notebook/16d10493731a4bebeb353de88f3427006e13da11
