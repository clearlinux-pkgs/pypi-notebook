...
Version  : 6.4.9
Release  : 85
URL      : https://files.pythonhosted.org/packages/60/48/af81c7e000901a9de45397f4348259743e84e74c9466d000bd27d14dfb7a/notebook-6.4.9.tar.gz
Source0  : https://files.pythonhosted.org/packages/60/48/af81c7e000901a9de45397f4348259743e84e74c9466d000bd27d14dfb7a/notebook-6.4.9.tar.gz
...
%prep
%setup -q -n notebook-6.4.9
cd %{_builddir}/notebook-6.4.9
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1647271742
...
cp %{_builddir}/notebook-6.4.9/LICENSE %{buildroot}/usr/share/package-licenses/pypi-notebook/16d10493731a4bebeb353de88f3427006e13da11
