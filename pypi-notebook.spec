...
Source0  : https://files.pythonhosted.org/packages/f4/ce/dc27e135a1020283c5a1855236015cf9bbd68424a188eb1f3af360a4bebb/notebook-6.4.7.tar.gz
...
%prep
%setup -q -n notebook-6.4.7
cd %{_builddir}/notebook-6.4.7
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1642031094
...
cp %{_builddir}/notebook-6.4.7/LICENSE %{buildroot}/usr/share/package-licenses/pypi-notebook/16d10493731a4bebeb353de88f3427006e13da11
