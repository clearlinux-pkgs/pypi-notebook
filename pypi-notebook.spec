...
%prep
%setup -q -n notebook-6.4.12
cd %{_builddir}/notebook-6.4.12
pushd ..
cp -a notebook-6.4.12 buildavx2
popd
...
cp %{_builddir}/notebook-6.4.12/LICENSE %{buildroot}/usr/share/package-licenses/pypi-notebook/16d10493731a4bebeb353de88f3427006e13da11
